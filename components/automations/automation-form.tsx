...
interface AutomationFormProps {
  automation?: Automation | AutomationWithActions | null;
  onSubmit: (data: CreateAutomationInput | UpdateAutomationInput) => Promise<void>;
  onCancel: () => void;
...
// =============================================================================
// Trigger Category Grouping
// =============================================================================

const triggerCategories = [
  {
    name: 'Contacts',
    triggers: ['new_contact', 'contact_updated', 'contact_tagged'],
  },
  {
    name: 'Deals',
    triggers: ['deal_created', 'deal_stage_changed', 'deal_won', 'deal_lost'],
  },
  {
    name: 'Content',
    triggers: ['form_submitted', 'feedback_received'],
  },
  {
    name: 'Projects',
    triggers: ['task_completed', 'task_created'],
  },
  {
    name: 'System',
...
export function AutomationForm({
  ...
  const form = useForm<AutomationFormValues>({
    ...
    defaultValues: {
      ...
      cooldown_seconds: automation?.cooldown_seconds ?? 0,
    },
  });
  ...
  const handleSubmit = async (values: AutomationFormValues) => {
    const data: CreateAutomationInput | UpdateAutomationInput = {
      name: values.name,
          ...
          {isEditing && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Control whether this automation is active.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <FormField
